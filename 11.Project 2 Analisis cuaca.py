...
def ambil_data_cuaca(kota, api_key):
    ...
    """
    url = f'http://api.openweathermap.org/data/2.5/forecast?q={kota}&appid={api_key}&units=metric'  # Menambahkan http://
...
def main():
    ...
    api_key = '59a2c5b28916df2314cb92edf4829793'  # Ganti dengan kunci API Anda
